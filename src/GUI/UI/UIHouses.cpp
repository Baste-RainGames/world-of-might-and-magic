...
void NPCHireableDialogPrepare() {
    ...
    pDialogueWindow = new GUIWindow(WINDOW_Dialogue, {0, 0}, {640, 350});
...
void updateHouseNPCTopics(int npc) {
    ...
    if (houseNpcs[npc].type == HOUSE_TRANSITION) {
        ...
        pDialogueWindow = new GUIWindow(WINDOW_Dialogue, {0, 0}, { 640, 480 });
...
void GUIWindow_House::reinitDialogueWindow() {
    ...
    pDialogueWindow = new GUIWindow(WINDOW_Dialogue, {0, 0}, {640, 345});
...
GUIWindow_House::GUIWindow_House(HouseId houseId) : GUIWindow(WINDOW_HouseInterior, {0, 0}, {640, 480}), _houseId(houseId) {
