...
GUIWindow_CharacterRecord::GUIWindow_CharacterRecord(int uActiveCharacter, ScreenType screen)
    : GUIWindow(WINDOW_CharacterRecord, {0, 0}, { 640, 480 }) {
    pEventTimer->setPaused(true);
    bRingsShownInCharScreen = false;
    CharacterUI_LoadPaperdollTextures();
    current_screen_type = screen;

    pCharacterScreen_StatsBtn = CreateButton({pViewport->uScreen_TL_X + 12, pViewport->uScreen_TL_Y + 308},
    ...
    pCharacterScreen_SkillsBtn = CreateButton({pViewport->uScreen_TL_X + 102, pViewport->uScreen_TL_Y + 308},
    ...
    pCharacterScreen_InventoryBtn = CreateButton({pViewport->uScreen_TL_X + 192, pViewport->uScreen_TL_Y + 308},
    ...
    pCharacterScreen_AwardsBtn = CreateButton({pViewport->uScreen_TL_X + 282, pViewport->uScreen_TL_Y + 308},
    ...
    pCharacterScreen_ExitBtn = CreateButton({pViewport->uScreen_TL_X + 371, pViewport->uScreen_TL_Y + 308},
