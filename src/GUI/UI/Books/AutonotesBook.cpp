...
GUIWindow_AutonotesBook::GUIWindow_AutonotesBook() : GUIWindow_Book() {
    ...
    pBtn_Book_1 = CreateButton({pViewport->uScreen_TL_X + 398, pViewport->uScreen_TL_Y + 1}, {50, 34}, 1, 0,
    ...
    pBtn_Book_2 = CreateButton({pViewport->uScreen_TL_X + 398, pViewport->uScreen_TL_Y + 38}, {50, 34}, 1, 0,
    ...
    pBtn_Book_3 = CreateButton({pViewport->uScreen_TL_X + 398, pViewport->uScreen_TL_Y + 113}, {50, 34}, 1, 0,
    ...
    pBtn_Book_4 = CreateButton({pViewport->uScreen_TL_X + 399, pViewport->uScreen_TL_Y + 150}, {50, 34}, 1, 0,
    ...
    pBtn_Book_5 = CreateButton({pViewport->uScreen_TL_X + 397, pViewport->uScreen_TL_Y + 188}, {50, 34}, 1, 0,
    ...
    pBtn_Book_6 = CreateButton({pViewport->uScreen_TL_X + 397, pViewport->uScreen_TL_Y + 226}, {50, 34}, 1, 0,
    ...
    pBtn_Autonotes_Misc = CreateButton({pViewport->uScreen_TL_X + 397, pViewport->uScreen_TL_Y + 264}, {50, 34}, 1, 0,
    ...
    pBtn_Autonotes_Instructors = CreateButton({pViewport->uScreen_TL_X + 397, pViewport->uScreen_TL_Y + 302}, {50, 34}, 1, 0,
...
void GUIWindow_AutonotesBook::Update() {
    ...
    render->DrawTextureNew(pViewport->uScreen_TL_X / 640.0f, pViewport->uScreen_TL_Y / 480.0f, ui_book_autonotes_background);
    ...
    if (_bookButtonClicked && _bookButtonAction == BOOK_NOTES_POTION) {
        if (autonoteBookDisplayType == AUTONOTE_POTION_RECIPE) {
            render->DrawTextureNew((pViewport->uScreen_TL_X + 398) / 640.0f, (pViewport->uScreen_TL_Y + 113) / 480.0f, ui_book_button3_on);
        } else {
        ...
        if (autonoteBookDisplayType == AUTONOTE_POTION_RECIPE) {
            ...
            render->DrawTextureNew((pViewport->uScreen_TL_X + 408) / 640.0f, (pViewport->uScreen_TL_Y + 113) / 480.0f, ui_book_button3_off);
        }
    }

    if (_bookButtonClicked && _bookButtonAction == BOOK_NOTES_FOUNTAIN) {
        if (autonoteBookDisplayType == AUTONOTE_STAT_HINT) {
            render->DrawTextureNew((pViewport->uScreen_TL_X + 399) / 640.0f, (pViewport->uScreen_TL_Y + 150) / 480.0f, ui_book_button4_on);
        } else {
            pAudioPlayer->playUISound(SOUND_StartMainChoice02);
        ...
        if (autonoteBookDisplayType == AUTONOTE_STAT_HINT) {
            ...
            render->DrawTextureNew((pViewport->uScreen_TL_X + 408) / 640.0f, (pViewport->uScreen_TL_Y + 150) / 480.0f, ui_book_button4_off);
        }
    }

    if (_bookButtonClicked && _bookButtonAction == BOOK_NOTES_OBELISK) {
        if (autonoteBookDisplayType == AUTONOTE_OBELISK) {
            render->DrawTextureNew((pViewport->uScreen_TL_X + 397) / 640.0f, (pViewport->uScreen_TL_Y + 188) / 480.0f, ui_book_button5_on);
        } else {
            pAudioPlayer->playUISound(SOUND_StartMainChoice02);
        ...
        if (autonoteBookDisplayType == AUTONOTE_OBELISK) {
            ...
            render->DrawTextureNew( (pViewport->uScreen_TL_X + 408) / 640.0f, (pViewport->uScreen_TL_Y + 188) / 480.0f, ui_book_button5_off);
        }
    }

    if (_bookButtonClicked && _bookButtonAction == BOOK_NOTES_SEER) {
        if (autonoteBookDisplayType == AUTONOTE_SEER) {
            render->DrawTextureNew((pViewport->uScreen_TL_X + 397) / 640.0f, (pViewport->uScreen_TL_Y + 226) / 480.0f, ui_book_button6_on);
        } else {
            pAudioPlayer->playUISound(SOUND_StartMainChoice02);
        ...
        if (autonoteBookDisplayType == AUTONOTE_SEER) {
            ...
            render->DrawTextureNew((pViewport->uScreen_TL_X + 408) / 640.0f, (pViewport->uScreen_TL_Y + 226) / 480.0f, ui_book_button6_off);
        }
    }

    if (_bookButtonClicked && _bookButtonAction == BOOK_NOTES_MISC) {
        if (autonoteBookDisplayType == AUTONOTE_MISC) {
            render->DrawTextureNew((pViewport->uScreen_TL_X + 397) / 640.0f, (pViewport->uScreen_TL_Y + 264) / 480.0f, ui_book_button7_on);
        } else {
            pAudioPlayer->playUISound(SOUND_StartMainChoice02);
        ...
        if (autonoteBookDisplayType == AUTONOTE_MISC) {
            ...
            render->DrawTextureNew((pViewport->uScreen_TL_X + 408) / 640.0f, (pViewport->uScreen_TL_Y + 263) / 480.0f, ui_book_button7_off);
        }
    }

    if (_bookButtonClicked && _bookButtonAction == BOOK_NOTES_INSTRUCTORS) {
        if (autonoteBookDisplayType == AUTONOTE_TEACHER) {
            render->DrawTextureNew((pViewport->uScreen_TL_X + 397) / 640.0f, (pViewport->uScreen_TL_Y + 302) / 480.0f, ui_book_button8_on);
        } else {
            pAudioPlayer->playUISound(SOUND_StartMainChoice02);
        ...
        if (autonoteBookDisplayType == AUTONOTE_TEACHER) {
            ...
            render->DrawTextureNew((pViewport->uScreen_TL_X + 408) / 640.0f, (pViewport->uScreen_TL_Y + 302) / 480.0f, ui_book_button8_off);
        }
    }
