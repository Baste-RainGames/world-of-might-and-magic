...
GUIWindow_MapBook::GUIWindow_MapBook() {
    ...
    pBtn_Book_1 = CreateButton({pViewport->uScreen_TL_X + 398, pViewport->uScreen_TL_Y + 1}, {50, 34}, 1, 0, UIMSG_ClickBooksBtn,
         std::to_underlying(BOOK_ZOOM_IN), Io::InputAction::ZoomIn, localization->GetString(LSTR_ZOOM_IN), {ui_book_button1_on});
    pBtn_Book_2 = CreateButton({pViewport->uScreen_TL_X + 398, pViewport->uScreen_TL_Y + 38}, {50, 34}, 1, 0, UIMSG_ClickBooksBtn,
         std::to_underlying(BOOK_ZOOM_OUT), Io::InputAction::ZoomOut, localization->GetString(LSTR_ZOOM_OUT), {ui_book_button2_on});
    pBtn_Book_3 = CreateButton({pViewport->uScreen_TL_X + 397, pViewport->uScreen_TL_Y + 113}, {50, 34}, 1, 0, UIMSG_ClickBooksBtn,
         std::to_underlying(BOOK_SCROLL_UP), Io::InputAction::DialogUp, localization->GetString(LSTR_SCROLL_UP), {ui_book_button3_on});
    pBtn_Book_4 = CreateButton({pViewport->uScreen_TL_X + 397, pViewport->uScreen_TL_Y + 150}, {50, 34}, 1, 0, UIMSG_ClickBooksBtn,
         std::to_underlying(BOOK_SCROLL_DOWN), Io::InputAction::DialogDown, localization->GetString(LSTR_SCROLL_DOWN), {ui_book_button4_on});
    pBtn_Book_5 = CreateButton({pViewport->uScreen_TL_X + 397, pViewport->uScreen_TL_Y + 188}, {50, 34}, 1, 0, UIMSG_ClickBooksBtn,
    ...
    pBtn_Book_6 = CreateButton({pViewport->uScreen_TL_X + 397, pViewport->uScreen_TL_Y + 226}, {50, 34}, 1, 0, UIMSG_ClickBooksBtn,
...
void GUIWindow_MapBook::Update() {
    ...
    render->DrawTextureNew(pViewport->uScreen_TL_X / 640.0f, pViewport->uScreen_TL_Y / 480.0f, ui_book_map_background);

    if ((_bookButtonClicked && _bookButtonAction == BOOK_ZOOM_IN) || viewparams->uMapBookMapZoom / 128 >= 12) {
        render->DrawTextureNew((pViewport->uScreen_TL_X + 408) / 640.0f, (pViewport->uScreen_TL_Y + 2) / 480.0f, ui_book_button1_off);
    } else {
    ...
    if ((_bookButtonClicked && _bookButtonAction == BOOK_ZOOM_OUT) || viewparams->uMapBookMapZoom / 128 <= 3) {
        render->DrawTextureNew((pViewport->uScreen_TL_X + 408) / 640.0f, (pViewport->uScreen_TL_Y + 38) / 480.0f, ui_book_button2_off);
    } else {
