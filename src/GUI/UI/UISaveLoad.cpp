...
void GUIWindow_Save::Update() {
    if (GetCurrentMenuID() != MENU_SAVELOAD && GetCurrentMenuID() != MENU_LoadingProcInMainMenu) {
        render->DrawTextureNewScaled(8 / 640.0f, 8 / 480.0f, saveload_ui_loadsave);
        render->DrawTextureNewScaled(241 / 640.0f, 302 / 480.0f, saveload_ui_saveu);
        render->DrawTextureNewScaled(18 / 640.0f, 139 / 480.0f, saveload_ui_save_up);
        render->DrawTextureNewScaled(351 / 640.0f, 302 / 480.0f, saveload_ui_x_u);
    }
...
void GUIWindow_Load::Update() {
    ...
    if (GetCurrentMenuID() != MENU_SAVELOAD && GetCurrentMenuID() != MENU_LoadingProcInMainMenu) {
        render->DrawTextureNewScaled(8 / 640.0f, 8 / 480.0f, saveload_ui_loadsave);
        render->DrawTextureNewScaled(241 / 640.0f, 302 / 480.0f, saveload_ui_loadu);
        render->DrawTextureNewScaled(18 / 640.0f, 139 / 480.0f, saveload_ui_load_up);
        render->DrawTextureNewScaled(351 / 640.0f, 302 / 480.0f, saveload_ui_x_u);
    }
...
static void UI_DrawSaveLoad(bool save) {
    if (pSavegameList->pSavegameUsedSlots[pSavegameList->selectedSlot]) {
        ...
        if (pSavegameList->pSavegameThumbnails[pSavegameList->selectedSlot]) {
            render->DrawTextureNewScaled((pGUIWindow_CurrentMenu->uFrameX + 276) / 640.0f, (pGUIWindow_CurrentMenu->uFrameY + 171) / 480.0f,
    ...
    if (GetCurrentMenuID() == MENU_LoadingProcInMainMenu) {
        ...
        render->DrawTextureNewScaled((216 + framex) / 640.f, (217 + framey + stopPos) / 480.f, scrollstop);
