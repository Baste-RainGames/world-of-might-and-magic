...
class NullRenderer : public BaseRenderer {
 public:
    ...
    virtual void SetUIClipRectUnscaled(const Recti &rect) override;
    ...
    virtual void FillRectFastScaled(int uX, int uY, int uWidth, int uHeight, Color uColor32) override;
